...
def match_species_names(df: pd.DataFrame) -> list:    
    ...
    genus_species_common_dict = {
        "Abies": ["Abies alba", "Silver fir", "Abies grandis", "Grand fir", "Abies sibirica", "Fir", 
        ...
        "Quercus": ["Quercus robur", "English oak", "Quercus petraea", "Sessile oak", "Quercus rubra", "Northern red oak", 
        ...
        "Acer": ["Acer pseudoplatanus", "Sycamore maple", "Acer platanoides", "Norway maple", "Acer campestre", "Field maple", 
                "Misc. deciduous trees with long life expectancy"],
        ...
        "Sorbus": ["Sorbus domestica", "Service tree", "Sorbus spp.", "Sorbus aria", "Common whitebeam", "Sorbus aucuparia", 
                "European rowan", "Sorbus torminalis", "Wild service tree", "Misc. deciduous trees with long life expectancy"],
        "Betula": ["Betula pendula", "Silver birch", "Betula pubescens", "Betula pubescens var. glabrata", "Downy birch", 
                "Misc. deciduous trees with short life expectancy"],
        "Alnus": ["Alnus glutinosa", "Black alder", "Alnus incana", "Grey alder"],
        "Populus": ["Populus tremula", "Common aspen", "Populus nigra", "European black poplar", "Populus × canescens", "Grey poplar", 
                    "Populus alba", "Silver poplar", "Populus balsamifera", "Balsam poplar", 
                    "Misc. deciduous trees with short life expectancy"],
        "Salix": ["Salix spp.", "Willow", "Misc. deciduous trees with short life expectancy"],
        "Prunus": ["Prunus padus", "Bird cherry", "Prunus avium", "Wild cherry", "Prunus serotina", "Black cherry", 
                "Misc. deciduous trees with short life expectancy"],
