...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Match genus names in functions to specific genus list in the script.'
    )
    parser.add_argument(
        'script_path',
        type=str,
        help='Path to the Python script file to be examined.',
    )
    parser.add_argument(
        '--genus',
        type=str,
        nargs='*',
        help="List of genus to filter the output (e.g. 'Abies', 'Pinus').",
    )
